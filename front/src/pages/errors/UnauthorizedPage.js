    ...
    return (
        <main className="min-h-screen bg-background flex items-center justify-center p-4">
            ...
            <div className="text-center">
                ...
                <h1 className="mt-4 text-5xl font-semibold tracking-tight text-balance text-slate-900 dark:text-slate-50 sm:text-7xl">Acesso
                    não autorizado</h1>
                <p className="mt-6 text-lg font-medium text-pretty text-gray-400 sm:text-xl/8">Faça login com as
                    credenciais apropriadas para acessar este recurso.</p>
