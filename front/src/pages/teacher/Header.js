            ...
            <div className="flex items-center gap-2">
                ...
                <button
                    ...
                    <span className="relative flex size-8 shrink-0 overflow-hidden rounded-full w-8 h-8">
                        <span
                            className="flex size-full items-center justify-center rounded-full bg-primary/10 text-primary text-sm">PM</span>
                    </span>
                    <span
                        className="text-sm font-medium hidden sm:inline">Prof. Maria Silva</span>
                </button>
            </div>
        </header>
    </>
